...
1. **Log signal correlation timeline** _(Large)_
...
2. **Application dependency graph exporter** _(Large)_
...
3. **First-blocked-edge incident runner** _(Large)_
...
4. **Resource policy condition mismatch analyzer** _(Large)_
...
5. **Multi-region drift and failover readiness audit** _(Large)_
...
6. **Queue/DLQ replay readiness analyzer** _(Large)_
...
7. **Application health narrative generator** _(XLarge)_
