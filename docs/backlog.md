...
1. **Cross-account invocation analyzer** _(Large)_
...
2. **Dead-letter and retry topology audit** _(XLarge)_
...
3. **End-to-end transaction trace plan** _(XLarge)_
...
4. **Risk-scored dependency health summary** _(XLarge)_
