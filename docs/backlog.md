...
1. **KMS-dependent path checker** _(Large)_
...
2. **Lambda invocation path proof** _(Large)_
...
3. **Lambda VPC outbound URL reachability check** _(Large)_
...
4. **Private AWS API reachability check** _(Large)_
...
5. **Security group path simulator for Lambda** _(Large)_
...
6. **DNS and split-horizon risk detector** _(Large)_
...
7. **Concurrency bottleneck investigator** _(Large)_
...
8. **Cross-account invocation analyzer** _(Large)_
...
9. **Dead-letter and retry topology audit** _(XLarge)_
...
10. **End-to-end transaction trace plan** _(XLarge)_
...
11. **Risk-scored dependency health summary** _(XLarge)_
